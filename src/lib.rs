...
pub use solver::{
    ...
    FactoredVersionSolutions, IncompatibilityConstraint, IncompatibilityConstraintTerm,
    IncompatibilityConstraints, MaximalSolutions, PackageDecision, PackagePreference,
    PackageResolutionStatistics, PreferenceAlternative, PreferenceDecision, PreferenceFactor,
    SelectedDependencies, VersionAlternative, VersionFactor, VersionOrdering, resolve,
    resolve_factored_maximal_solutions_for_preference_decisions,
    ...
    resolve_maximal_solutions_for_preference_decisions,
